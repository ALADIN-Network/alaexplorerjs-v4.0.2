const {PublicKey} = require('alaexplorerjs-v4.0.2-ecc-v1.6.1')
...
/** Configures Fcbuffer for ALA specific structs and types. */
module.exports = (config = {}, extendedSchema) => {
  ...
  // If alad does not have an ABI setup for a certain message.type, it will throw
  ...
  const customTypes = Object.assign({}, alaTypes, config.customTypes)
